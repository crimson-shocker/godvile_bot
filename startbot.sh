#!/usr/bin/env bash
user_ip=`cat ./passwd|grep ip|awk'{print $2}'`
case $1 in
  ...
  *)
    ...
    #/usr/bin/docker run  --rm  -p $user_ip:5901:5901  --name godvile -v /opt/godvile_bot/:/opt/ bot /opt/godville.py >>/var/log/bot.log
    echo +++++++++++++++++++++++++++++++++++++++++++++++++++++ >>/var/log/bot.log
